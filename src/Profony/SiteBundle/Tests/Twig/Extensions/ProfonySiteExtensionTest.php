...
namespace Profony\SiteBundle\Tests\Twig\Extensions;

use Profony\SiteBundle\Twig\Extensions\ProfonySiteExtension;

class ProfonySiteExtensionTest extends \PHPUnit_Framework_TestCase
{
    public function testCreatedAgo()
    {
        $blog = new ProfonySiteExtension();
